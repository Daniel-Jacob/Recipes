                ...
                reference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        for (DataSnapshot s : dataSnapshot.child("Users").child(user.getUid()).child("Recipes").getChildren()) {
                            ...
                            if (recipe.getTitle().equals(recipes.getRecipes().get(position).getTitle())
                    ...
                    reference.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            for (DataSnapshot s : dataSnapshot.child("Users").child(user.getUid()).child("Recipes").getChildren()) {
                                ...
                                if (recipe != null && recipe.getTitle().equals(recipesLongClick.getRecipes().get(position).getTitle())
                                        && recipe.getImage().equals(recipesLongClick.getRecipes().get(position).getImage())
                                        && recipe.getIngredients().equals(recipesLongClick.getRecipes().get(position).getIngredients())
                                        && recipe.getAttributes().equals(recipesLongClick.getRecipes().get(position).getAttributes())) {
                        ...
                        @Override
                        // fetching data from database got cancelled
                        public void onCancelled(DatabaseError databaseError) {
                            Toast.makeText(context, "A database error of type" +
                                    databaseError + "occured", Toast.LENGTH_SHORT).show();
                        }
